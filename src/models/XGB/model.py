...
class GlobalClassifier:
    ...
    def __init__(self, input_shape, output_dim, model_name: str, *args, **kwargs):
        ...
        self.model = XGBClassifier(*args, **kwargs, verbosity=True, use_label_encoder=False)
...
class ParallelClassifier:
    ...
    def __init__(self, input_shape, output_dim, model_name: str, *args, **kwargs):
        ...
        # Initialize the SVM model
        self.models = {
            feat_idx: XGBClassifier(*args, **kwargs, verbosity=True, use_label_encoder=True)
    ...
    def predict(self, X, y=None, *args, **kwargs):
        ...
        _dic_placeholder = {}
        for feat_idx in range(self.num_feats):
            _dic_placeholder[feat_idx] = self.models[feat_idx].predict(X[:, :, feat_idx])
