...
from src.models.SVM.model import GlobalClassifier, ParallelClassifier
...
def main():
    ...
    if args["feature_parallelize"]:
        test_dir = f"results/SVM_parallel/{cur_time_as_str}/"
    else:
        test_dir = f"results/SVM_Global/{cur_time_as_str}/"
    ...
    # ===================== CSV LOGGING
    csv_path = "results/SVM_Global/tracker.csv" if not args["feature_parallelize"] else "results/SVM_parallel/tracker.csv"
    header = ["data_name", "time_window", "feat_subset", "train_test_ratio", "train_val_ratio", "seed",
    ...
    row_append = data_name, args["time_window"], args["feat_subset"], args["train_test_ratio"], args["train_val_ratio"], args["seed"], *paper_metrics
